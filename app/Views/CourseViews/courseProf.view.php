...
<div class="container">
<form class="form">
  <span class="form-title">Espace Partage des Cours</span>
  <div class="form-paragraph">
    <label for="email">Objet de cours</label>
    <input type="text" autocomplete="off" name="Titre" class="input" placeholder="Objet">
  </div>
  <div class="form-paragraph">
