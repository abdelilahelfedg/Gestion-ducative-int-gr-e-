...
<div class="form">
  ...
  <a href="<?= ROOT . "/" . "AbsenceControl" . "/" . "Faire_Absence";?>"><button type="submit" name="Faire_Absence">Faire Absence</button></a>
  <a href="<?= ROOT . "/" . "AbsenceControl" . "/" . "Voir_statistique";?>"><button type="submit" name="Faire_Absence">Voir les statistiques</button></a>

   <a href="<?= ROOT . "/" . "AbsenceControl" . "/" . "Update";?>"><button  type="submit" name="modifier">Modifier</button></a>




<form action="" name="retour_arriere">
<a href=""><button  type="submit" name="modifier">Retour en arriere</button></a>

</form>
<a href="<?= ROOT."/"."HomeProf"?>"><button>Retour au home</button></a>
</div>
</div>
