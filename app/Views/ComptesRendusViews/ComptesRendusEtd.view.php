...
<head>
    ...
    <title>Partage des Comptes Rendus</title>
        ...
        <div class="row justify-content-center">
            <div class="col-5">
                <div class="card bg-light my-5">
                    <div class="card-body">
                        <div class="card-title text-center mb-3">Espace de Partage des Comptes Rendus</div>
...
<div class="container">
<form class="form">
  <span class="form-title">Espace de Partage des Comptes Rendus</span>
...
<a href="<?= ROOT."/"."HomeEtud"?>"><button>Retour</button></a>
</form>
</div>
