...
<head>
    ...
    <title>Définir un Deadline</title>
...
<div class="container">
<form class="form">
  <span class="form-title">Definition du Deadline</span>
  <div class="form-paragraph">
    <label for="email"><strong>Saisir un deadline</strong></label>
    <input type="date" name="Date_f" id="dead" class="form-control mb-3" placeholder="Date" required>
    <input type="time" name="Time_f" id="dead" class="form-control mb-3" placeholder="Time" required>
  </div>
  <div class="form-paragraph">
    <label for="email"><strong>Choisir un Module</strong></label>
