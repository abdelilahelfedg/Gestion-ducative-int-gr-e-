...
<div class="container my-5">
    <div class="row pt-5 mb-5">
        <div class="col-md-6">
            <h3><a href="<?= ROOT . "/" . "ComptesRendusControl" . "/" . "Definir"?>"></a>
            <div class="card p-3 mb-2 "><i class="fas fa-calendar-alt icon fa-3x"></i>
            Definir un Deadline
                </div>
              </a></h3>
            </div>
        
        <div class="col-md-6"> <!-- à voir avec abdelilah -->
            <div class="card p-3 mb-2">
                <h5>Choisir un Module</h5>
                <form action="<?= ROOT ."/" ."ComptesRendusControl/" ."Acceder" ?>" method="POST">
                    ...
                    <button>Acces Comptes Rendus</button>
                </form>
