...
<body class="bg-blue-300 text-gray-900 tracking-wider leading-normal">
	...
	<div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2">
		...
		<!--Title-->
		<h1 class="flex items-center font-sans font-bold break-normal text-black px-2 py-8 text-xl md:text-2xl">
      <div class="mx-2">Vos Archives</div>
		</h1>
