...
class NotesControl
{
    ...
    public function Saisir(){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if( $result ){
                    $url  = 'http://localhost/Gestion_Educative_Integree/public/NotesControl/Afficher/?Niveau=' . $data1['Niveau'] . '&Categorie=' . $_POST['Categorie'] . '&Module=' . $_POST['Module'];
                    header('Location: '. $url);
                    exit;
                }else{
                    ?>
    ...
    public function Modifier(){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $url  = 'http://localhost/Gestion_Educative_Integree/public/NotesControl/AfficherUpdate/?Niveau=' . $data1['Niveau'] . '&Categorie=' . $_POST['Categorie'] . '&Module=' . $_POST['Module'];
            header('Location: '. $url);
            exit;                    
    ...
    public function Afficher(){
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $url  = 'http://localhost/Gestion_Educative_Integree/public/NotesControl/Saisir?message';
                header('Location: '. $url);
                exit;
    ...
    public function AfficherUpdate(){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $url  = 'http://localhost/Gestion_Educative_Integree/public/NotesControl/Modifier?message';
            header('Location: '. $url);
            exit;
